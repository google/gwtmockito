...
/**
 * Provides a fake implementations of {@link HistoryImpl} that returns true from
 * {@link HistoryImpl#init} to signal that the history implementation is safe to use.
 *
